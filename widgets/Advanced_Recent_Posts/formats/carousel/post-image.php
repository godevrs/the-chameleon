<?php global $TheChameleon, $data;	
	...
	<?php if( $data['show_post_media'] or $data['show_post_excerpt'] ) : ?>
		<section class="col100 post-widget-content post-widget-content-carousel">		
			...
			<div class="post-widget-caption-carousel">
			    <?php if ( $data['show_post_title']=="1" ) : ?>
					<header class="col100 post-widget-header post-widget-header-carousel">
					    <?php if ( $title_size == '' ) : ?>
				...
				<?php if ( $meta_pattern != '' ) : ?>			
					<section class="col100 post-widget-meta post-widget-meta-carousel">									
